...
proc create_hier_cell_axi_iic1 { parentCell nameHier } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_interconnect_0_M11_AXI [get_bd_intf_pins S_AXI] [get_bd_intf_pins axi_iic_1/S_AXI]

  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins ARESETN] [get_bd_pins axi_iic_1/s_axi_aresetn]
  connect_bd_net -net Net [get_bd_pins iic1_scl] [get_bd_pins iobuf_0/io]
  connect_bd_net -net Net1 [get_bd_pins iic1_sda] [get_bd_pins iobuf_1/io]
  connect_bd_net -net axi_iic1_data_o [get_bd_pins axi_iic_1/scl_i] [get_bd_pins iobuf_0/data_o]
  connect_bd_net -net axi_iic1_data_o1 [get_bd_pins axi_iic_1/sda_i] [get_bd_pins iobuf_1/data_o]
  connect_bd_net -net axi_iic_1_iic2intc_irpt [get_bd_pins iic2intc_irpt] [get_bd_pins axi_iic_1/iic2intc_irpt]
  connect_bd_net -net axi_iic_1_scl_o [get_bd_pins axi_iic_1/scl_o] [get_bd_pins iobuf_0/data_i]
  connect_bd_net -net axi_iic_1_scl_t [get_bd_pins axi_iic_1/scl_t] [get_bd_pins iobuf_0/data_t]
  connect_bd_net -net axi_iic_1_sda_o [get_bd_pins axi_iic_1/sda_o] [get_bd_pins iobuf_1/data_i]
  connect_bd_net -net axi_iic_1_sda_t [get_bd_pins axi_iic_1/sda_t] [get_bd_pins iobuf_1/data_t]
  connect_bd_net -net ddr4_0_addn_ui_clkout1 [get_bd_pins ACLK] [get_bd_pins axi_iic_1/s_axi_aclk]
...
here on its own." [get_bd_cells /gfe_subsystem/axi_clock_converter_0]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M11_AXI [get_bd_intf_pins axi_iic1/S_AXI] [get_bd_intf_pins axi_interconnect_0/M11_AXI]
  ...
  connect_bd_net -net axi_iic_1_iic2intc_irpt [get_bd_pins axi_iic1/iic2intc_irpt] [get_bd_pins xlconcat_0/In8]
