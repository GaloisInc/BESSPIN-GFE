...
proc create_hier_cell_axi_quad_spi1 { parentCell nameHier } {
  ...
  create_bd_pin -dir IO spi1_miso
  create_bd_pin -dir IO spi1_mosi
  create_bd_pin -dir IO spi1_sck
  create_bd_pin -dir IO spi1_ss
  ...
  connect_bd_net -net ACLK_1 [get_bd_pins ACLK] [get_bd_pins axi_quad_spi_1/ext_spi_clk] [get_bd_pins axi_quad_spi_1/s_axi_aclk]
  connect_bd_net -net ARESETN_1 [get_bd_pins ARESETN] [get_bd_pins axi_quad_spi_1/s_axi_aresetn]
  connect_bd_net -net Net [get_bd_pins spi1_mosi] [get_bd_pins iobuf_0/io]
  connect_bd_net -net Net1 [get_bd_pins spi1_miso] [get_bd_pins iobuf_1/io]
  connect_bd_net -net Net2 [get_bd_pins spi1_sck] [get_bd_pins iobuf_2/io]
  connect_bd_net -net Net3 [get_bd_pins spi1_ss] [get_bd_pins iobuf_3/io]
  connect_bd_net -net axi_quad_spi_0_io0_o [get_bd_pins axi_quad_spi_1/io0_o] [get_bd_pins iobuf_0/data_i]
  connect_bd_net -net axi_quad_spi_0_io0_t [get_bd_pins axi_quad_spi_1/io0_t] [get_bd_pins iobuf_0/data_t]
  connect_bd_net -net axi_quad_spi_0_io1_o [get_bd_pins axi_quad_spi_1/io1_o] [get_bd_pins iobuf_1/data_i]
  connect_bd_net -net axi_quad_spi_0_io1_t [get_bd_pins axi_quad_spi_1/io1_t] [get_bd_pins iobuf_1/data_t]
  connect_bd_net -net axi_quad_spi_0_ip2intc_irpt [get_bd_pins ip2intc_irpt] [get_bd_pins axi_quad_spi_1/ip2intc_irpt]
  connect_bd_net -net axi_quad_spi_0_sck_o [get_bd_pins axi_quad_spi_1/sck_o] [get_bd_pins iobuf_2/data_i]
  connect_bd_net -net axi_quad_spi_0_sck_t [get_bd_pins axi_quad_spi_1/sck_t] [get_bd_pins iobuf_2/data_t]
  connect_bd_net -net axi_quad_spi_0_ss_o [get_bd_pins axi_quad_spi_1/ss_o] [get_bd_pins iobuf_3/data_i]
  connect_bd_net -net axi_quad_spi_0_ss_t [get_bd_pins axi_quad_spi_1/ss_t] [get_bd_pins iobuf_3/data_t]
...
here on its own." [get_bd_cells /gfe_subsystem/axi_clock_converter_0]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M08_AXI [get_bd_intf_pins axi_interconnect_0/M08_AXI] [get_bd_intf_pins axi_quad_spi1/AXI_LITE]
  ...
  connect_bd_net -net Net1 [get_bd_pins spi1_mosi] [get_bd_pins axi_quad_spi1/spi1_mosi]
  connect_bd_net -net Net2 [get_bd_pins spi1_miso] [get_bd_pins axi_quad_spi1/spi1_miso]
  connect_bd_net -net Net3 [get_bd_pins spi1_sck] [get_bd_pins axi_quad_spi1/spi1_sck]
  connect_bd_net -net Net4 [get_bd_pins spi1_ss] [get_bd_pins axi_quad_spi1/spi1_ss]
  ...
  connect_bd_net -net axi_quad_spi1_ip2intc_irpt [get_bd_pins axi_quad_spi1/ip2intc_irpt] [get_bd_pins xlconcat_0/In5]
  ...
  connect_bd_net -net xlconstant_3_dout [get_bd_pins xlconcat_0/In6] [get_bd_pins xlconstant_3/dout]
...
proc create_root_design { parentCell } {
  ...
  set spi1_miso [ create_bd_port -dir IO spi1_miso ]
  set spi1_mosi [ create_bd_port -dir IO spi1_mosi ]
  set spi1_sck [ create_bd_port -dir IO spi1_sck ]
  set spi1_ss [ create_bd_port -dir IO spi1_ss ]
  ...
  connect_bd_net -net Net1 [get_bd_ports spi1_mosi] [get_bd_pins gfe_subsystem/spi1_mosi]
  connect_bd_net -net Net2 [get_bd_ports spi1_miso] [get_bd_pins gfe_subsystem/spi1_miso]
  connect_bd_net -net Net3 [get_bd_ports spi1_sck] [get_bd_pins gfe_subsystem/spi1_sck]
  connect_bd_net -net Net4 [get_bd_ports spi1_ss] [get_bd_pins gfe_subsystem/spi1_ss]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x62310000 [get_bd_addr_spaces ssith_processor_0/master0] [get_bd_addr_segs gfe_subsystem/axi_quad_spi1/axi_quad_spi_1/AXI_LITE/Reg] SEG_axi_quad_spi_1_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x62310000 [get_bd_addr_spaces ssith_processor_0/master1] [get_bd_addr_segs gfe_subsystem/axi_quad_spi1/axi_quad_spi_1/AXI_LITE/Reg] SEG_axi_quad_spi_1_Reg
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x62310000 [get_bd_addr_spaces gfe_subsystem/axi_dma_0/Data_MM2S] [get_bd_addr_segs gfe_subsystem/axi_quad_spi1/axi_quad_spi_1/AXI_LITE/Reg] SEG_axi_quad_spi_1_Reg
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x62310000 [get_bd_addr_spaces gfe_subsystem/axi_dma_0/Data_S2MM] [get_bd_addr_segs gfe_subsystem/axi_quad_spi1/axi_quad_spi_1/AXI_LITE/Reg] SEG_axi_quad_spi_1_Reg
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x62310000 [get_bd_addr_spaces gfe_subsystem/axi_dma_0/Data_SG] [get_bd_addr_segs gfe_subsystem/axi_quad_spi1/axi_quad_spi_1/AXI_LITE/Reg] SEG_axi_quad_spi_1_Reg
