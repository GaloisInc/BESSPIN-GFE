...
#
# project.tcl: Tcl script for re-creating project 'p1_soc'
#
...
proc help {} {
  ...
  puts "$script_file -tclargs \[--p1_name <name>\]"
  ...
  puts "\[--p1_name <name>\] Identifier for the p1 processor, used in naming files"
...
if { $::argc > 0 } {
  for {set i 0} {$i < [llength $::argv]} {incr i} {
    ...
    switch -regexp -- $option {
      ...
      "--p1_name" { incr i; set p1_name [lindex $::argv $i] }
