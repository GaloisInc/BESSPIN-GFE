...
BITFILE=$BASE_DIR/vivado/p1_chisel_soc/p1_chisel_soc.runs/impl_1/design_1.bit
LTXFILE=$BASE_DIR/vivado/p1_chisel_soc/p1_chisel_soc.runs/impl_1/design_1.ltx
