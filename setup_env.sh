...
function proc_picker {
	...
	if [ "$1" == "bluespec_p1" ]; then
	        ...
	        proc_name="chisel_p3"
	elif [ "$1" == "chisel_aws_p1" ]; then
		proc_name="chisel_aws_p1"
	elif [ "$1" == "chisel_aws_p2" ]; then
		proc_name="chisel_aws_p2"
	elif [ "$1" == "chisel_aws_p3" ]; then
		proc_name="chisel_aws_p3"
	elif [ "$1" == "bluespec_aws_p1" ]; then
		proc_name="bluespec_aws_p1"
	elif [ "$1" == "bluespec_aws_p2" ]; then
