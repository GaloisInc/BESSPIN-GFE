...
#
# Generated by export_simulation on Wed Feb 06 12:09:33 PST 2019
#
################################################################################
...
'-reset_run' switch to the './iobuf_1.sh' script.

./iobuf_1.sh -reset_run
...
./iobuf_1.sh -noclean_files

For more information on the script, please type './iobuf_1.sh -help'.
