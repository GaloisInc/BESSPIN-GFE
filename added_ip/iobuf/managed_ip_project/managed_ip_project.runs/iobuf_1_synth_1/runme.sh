...
HD_PWD='/home/cgoins/gfe/added_ip/iobuf/managed_ip_project/managed_ip_project.runs/iobuf_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iobuf_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iobuf_1.tcl
