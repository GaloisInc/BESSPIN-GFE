...
HD_PWD='/home/cgoins/gfe/added_ip/iobuf/managed_ip_project/managed_ip_project.runs/iobuf_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iobuf_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iobuf_0.tcl
