...
module mkSoC_Top(RST_N_por,
  ...
  wire [63 : 0] a_out_araddr__h11070,
		a_out_araddr__h15418,
		a_out_araddr__h7170,
		a_out_awaddr__h10087,
		a_out_awaddr__h14435,
		a_out_awaddr__h6187,
		addr___1__h10172,
		addr___1__h11155,
		addr___1__h14520,
  ...
  assign mem0_controller_axi4_deburster_rg_w_beat_count_ETC___d261 =
	     ...
	     mem0_controller_axi4_deburster_xactor_from_master_f_wr_addr$D_OUT[28:21] ;
  assign x__h10433 = flash_axi4_deburster_rg_w_beat_count + 8'd1 ;
  assign x__h10924 = flash_axi4_deburster_rg_b_beat_count + 8'd1 ;
  assign x__h11316 = flash_axi4_deburster_rg_ar_beat_count + 8'd1 ;
  assign x__h11514 = flash_axi4_deburster_rg_r_beat_count + 8'd1 ;
  assign x__h14781 = mem0_controller_axi4_deburster_rg_w_beat_count + 8'd1 ;
  assign x__h15272 = mem0_controller_axi4_deburster_rg_b_beat_count + 8'd1 ;
  assign x__h15664 = mem0_controller_axi4_deburster_rg_ar_beat_count + 8'd1 ;
  assign x__h15862 = mem0_controller_axi4_deburster_rg_r_beat_count + 8'd1 ;
  assign x__h6533 = boot_rom_axi4_deburster_rg_w_beat_count + 8'd1 ;
  assign x__h7024 = boot_rom_axi4_deburster_rg_b_beat_count + 8'd1 ;
  assign x__h7416 = boot_rom_axi4_deburster_rg_ar_beat_count + 8'd1 ;
  assign x__h7614 = boot_rom_axi4_deburster_rg_r_beat_count + 8'd1 ;
  ...
  begin
    ...
    v__h22537 = v__h22543 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (MUX_rg_state$write_1__SEL_2)
	$display("%0d: SoC_Top. Reset start ...", v__h22537);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h5679 = v__h5685 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (boot_rom_axi4_deburster_rg_reset)
	$display("%0d: %m::AXI4_Deburster.rl_reset", v__h5679);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (flash_axi4_deburster_rg_reset)
	$display("%0d: %m::AXI4_Deburster.rl_reset", v__h9579);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h13927 = v__h13933 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (mem0_controller_axi4_deburster_rg_reset)
	$display("%0d: %m::AXI4_Deburster.rl_reset", v__h13927);
  end
  // synopsys translate_on
endmodule  // mkSoC_Top
