...
set_clock_groups -asynchronous -group tck -group {default_250mhz_clk1_clk_p mmcm_clkout0 mmcm_clkout1} -group tck_internal

set_clock_uncertainty 2.000 [get_clocks *tck_internal*]
